...
def test_one_player_per_config_in_configuration_order() -> None:
    players = SimpleStrandsRoster(_CONFIGS, SimpleStrandsAgentFactory()).create_players()
...
def test_the_move_budget_comes_from_the_config() -> None:
    ...
    player = SimpleStrandsRoster([config], SimpleStrandsAgentFactory()).create_players()[0]
...
def test_an_empty_roster_fields_nobody() -> None:
    assert SimpleStrandsRoster([], SimpleStrandsAgentFactory()).create_players() == []
